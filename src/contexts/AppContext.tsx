...
const initialState: AppState = {
  ...
  widgets: [
    ...
    { id: 'notes', type: 'notes', title: 'Family Notes', enabled: true, position: 3 },
    { id: 'quick-tasks', type: 'quick-tasks', title: 'Quick Tasks', enabled: true, position: 4 },
    { id: 'calendar-stats', type: 'calendar-stats', title: 'Calendar Stats', enabled: true, position: 5 },
  ],
  icalImports: [],
